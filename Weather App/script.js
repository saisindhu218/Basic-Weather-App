//http://api.weatherapi.com/v1/current.json?key=df68341b89b44b1fb0a02423252407&q=bangalore&aqi=no
...
let target = 'Anantapur';

const fetchResults = async (targetLocation) =>{
    let url = `http://api.weatherapi.com/v1/current.json?key=df68341b89b44b1fb0a02423252407&q=${targetLocation}&aqi=no`;
